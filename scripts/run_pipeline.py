...
# Optional: Data quality validation (skip if Great Expectations not available)
try:
    from src.utils.validate_data import validate_telco_data
    VALIDATION_AVAILABLE = True
except ImportError:
    VALIDATION_AVAILABLE = False
    print("⚠️  Warning: Great Expectations not available. Skipping data validation.")
...
def main(args):
    ...
    with mlflow.start_run():
        ...
        if VALIDATION_AVAILABLE:
            ...
            print("⚠️  Skipping data validation (Great Expectations not available)")
            mlflow.log_metric("data_quality_pass", 0)  # Mark as not validated
